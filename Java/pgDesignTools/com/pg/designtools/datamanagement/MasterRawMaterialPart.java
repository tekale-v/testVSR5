...
public class MasterRawMaterialPart extends CommonProductData implements IProductData {

	public MasterRawMaterialPart() {
		super();
		getValidParents();
		getValidChild();
	}
	...
	public StringList getValidParents() {
		if(slValidParents.isEmpty()) {
			...
			slValidParents.add(DataConstants.TYPE_PG_MASTER_PRODUCT_PART);
		}

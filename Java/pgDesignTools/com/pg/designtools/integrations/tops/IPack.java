...
public class IPack {
	...
	public IPack(Boolean selected, String name, String units, String fixVar,
			String roundUp) {
		super();
	...
	public IPackInfo getInfo() {
		return info;
	}
	public void setInfo(IPackInfo info) {
		this.info = info;
	}
	...
	public String toString() {
		return this.getClass().getSimpleName() + " [" + selected + ", "+ name + ", " + units + ", " + fixVar + ", " + roundUp + ", " + dims + ", " + info + ","+ lenUnits + "," + wgtUnits  + "]";
	}
}

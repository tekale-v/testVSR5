...
@XmlType(name = "", propOrder = { "billofMaterialsFPPs", "substitutes" })
@XmlRootElement(name = "BillofMaterialsConsumerUnit", namespace = "")
public class BillofMaterialsConsumerUnit {

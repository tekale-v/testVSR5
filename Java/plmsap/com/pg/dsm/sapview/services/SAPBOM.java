...
public class SAPBOM implements ISAPBOM {
    ...
    public MapList getBOMInfoList(Context context, String objectOid, MapList objectList) throws FrameworkException {
        ...
        if(UIUtil.isNotNullAndNotEmpty(objectOid)) {
            ...
            objectList = getBOMStructure(incomingMap, objectList, false);
    ...
    public Map<Object, Object> getComplexInfo(Context context, Map<Object, Object> paramMap) throws FrameworkException {
        ...
        switch (level) {
            case 1:
                ...
                break;
            case 2: // case when type is: IP/COP
                isComplex = SAPConstants.IntermediateParts.isComplexBOM(context, objectMap);
                break;
            // case when type is: IP/COP
            default:
                if (hasParent) {
    ...
    public void displayBOMStructure(Context context, String objectOid) throws FrameworkException {
        ...
        StringList busSelects = SAPUtil.getBusSelects();
        ...
        MapList objectList = incomingObj.getRelatedObjects(context,
                ...
                0);                                 // limit
        objectList = getBOMStructure(incomingObjMap, objectList, true);
        objectList = getBOMInfoList(context, objectList);
        printMapList(objectList, false);
        logger.log(Level.INFO, "MapList after marking as complex: {0}", objectList);
    }
    /**
     * @param objectMap
     */

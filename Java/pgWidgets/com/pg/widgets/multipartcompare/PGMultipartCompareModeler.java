...
@ApplicationPath("/pgmultipartcompare")
public class PGMultipartCompareModeler extends ModelerBase {
	@Override
	public Class<?>[] getServices() {
		System.out.println("line 21: in getServices::");
		return new Class<?>[] {
			PGMultipartCompareServices.class
			};
	}

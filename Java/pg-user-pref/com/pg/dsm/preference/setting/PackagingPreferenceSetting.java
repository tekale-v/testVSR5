...
public class PackagingPreferenceSetting {
    boolean applied;

    private PackagingPreferenceSetting(Apply apply) {
    ...
    public static class Apply {
        ...
        public PackagingPreferenceSetting now(DomainObject domainObject, String objectOid, String symbolicType) throws Exception {
            try {
            ...
            return new PackagingPreferenceSetting(this);
        }

        private void applyNow(DomainObject domainObject, String objectOid, String symbolicType) throws Exception {
            try {
                Map<String, String> attributeMap = new HashMap<>();
                PackagingPreference packagingPreference = new PackagingPreference(this.context);
                UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
                String partType = packagingPreference.getPartType(); // get type from preferences
                if (UIUtil.isNotNullAndNotEmpty(partType)) {
                    ...
                    if (UIUtil.isNotNullAndNotEmpty(partType) && symbolicType.equalsIgnoreCase(partType)) { // if incoming type is equal to packaging preference - part type.
                        ...
                        if (!isFPPHALB(domainObject, symbolicType)) {
                            ...
                            if (userPreferenceUtil.isPreferencePhaseMatchWithPhaseAttribute(this.context, domainObject, packagingPreference.getPhase())) {
                                String manufacturingStatus = packagingPreference.getManufacturingStatus();
                ...
                this.applyReportedFunction(userPreferenceUtil, domainObject, symbolicType, packagingPreference.getReportedFunction());

                // apply structure release criteria
                String releaseCriteria = packagingPreference.getReleaseCriteria();
                ...
                // apply class
                String classValue = packagingPreference.getClassValue();
                ...
                String packagingComponentType = packagingPreference.getPackagingComponentType();
                ...
                String packagingMaterialType = packagingPreference.getPackagingMaterialType();
                ...
                String baseUnitOfMeasure = packagingPreference.getBaseUnitOfMeasure();

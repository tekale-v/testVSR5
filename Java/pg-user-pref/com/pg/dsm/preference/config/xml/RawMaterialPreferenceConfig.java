...
@XmlRootElement(name = "rawMaterialPreferenceConfig")
public class RawMaterialPreferenceConfig {
    ...
    @XmlElement(required = true, name = "materialFunction")
    protected MaterialFunction materialFunction;

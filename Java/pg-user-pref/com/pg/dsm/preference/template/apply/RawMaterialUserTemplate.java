...
public class RawMaterialUserTemplate {
    String category;
    String type;
    String phase;
    String mfgStatus;
    ...
    public RawMaterialUserTemplate(Context context, Map<Object, Object> objectMap) throws Exception {
        ...
        this.materialFunction = getPipeSeparatedStringFromMap(objectMap, DSMUPTConstants.Attributes.UPT_MATERIAL_FUNCTION.getSelect(context));
    }

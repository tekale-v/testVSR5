...
public class ProductPreferenceUtil {
    private static final Logger logger = Logger.getLogger(ProductPreferenceUtil.class.getName());

    public ProductPreferenceUtil() {
    }
    ...
    public String getPartType(Context context) throws FrameworkException {
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, PreferenceConstants.Preferences.PRODUCT_PART_TYPE.get());
    }
    ...
    public String getPartType(Context context, PreferenceManagement preferenceManagement, UserPreferenceUtil userPreferenceUtil) throws FrameworkException {
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, preferenceManagement, PreferenceConstants.Preferences.PRODUCT_PART_TYPE.get());
    }

    public String getPhase(Context context) throws FrameworkException {
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, PreferenceConstants.Preferences.PRODUCT_PHASE.get());
    }
    ...
    public String getPhase(Context context, PreferenceManagement preferenceManagement, UserPreferenceUtil userPreferenceUtil) throws FrameworkException {
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, preferenceManagement, PreferenceConstants.Preferences.PRODUCT_PHASE.get());
    }

    public String getManufacturingStatus(Context context) throws FrameworkException {
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, PreferenceConstants.Preferences.PRODUCT_MANUFACTURING_STATUS.get());
    }
    ...
    public String getManufacturingStatus(Context context, PreferenceManagement preferenceManagement, UserPreferenceUtil userPreferenceUtil) throws FrameworkException {
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, preferenceManagement, PreferenceConstants.Preferences.PRODUCT_MANUFACTURING_STATUS.get());
    }

    public String getStructureReleaseCriteria(Context context) throws FrameworkException {
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, PreferenceConstants.Preferences.PRODUCT_RELEASE_CRITERIA.get());
    }
    ...
    public String getStructureReleaseCriteria(Context context, PreferenceManagement preferenceManagement, UserPreferenceUtil userPreferenceUtil) throws FrameworkException {
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, preferenceManagement, PreferenceConstants.Preferences.PRODUCT_RELEASE_CRITERIA.get());
    }

    public String getClassValue(Context context) throws FrameworkException {
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, PreferenceConstants.Preferences.PRODUCT_CLASS.get());
    }
    ...
    public String getClassValue(Context context, PreferenceManagement preferenceManagement, UserPreferenceUtil userPreferenceUtil) throws FrameworkException {
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, preferenceManagement, PreferenceConstants.Preferences.PRODUCT_CLASS.get());
    }

    public String getReportedFunctionName(Context context) throws FrameworkException {
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        String reportedFunctionID = userPreferenceUtil.getAdminPropertyWithoutCache(context, PreferenceConstants.Preferences.PRODUCT_REPORTED_FUNCTION.get());
    ...
    public String getReportedFunctionID(Context context) throws FrameworkException {
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, PreferenceConstants.Preferences.PRODUCT_REPORTED_FUNCTION.get());
    }
    ...
    public String getProductComplianceRequired(Context context) throws FrameworkException {
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, PreferenceConstants.Preferences.PRODUCT_COMPLIANCE_REQUIRED.get());
    }
    ...
    public String getReportedFunction(Context context, PreferenceManagement preferenceManagement, UserPreferenceUtil userPreferenceUtil) throws FrameworkException {
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, preferenceManagement, PreferenceConstants.Preferences.PRODUCT_REPORTED_FUNCTION.get());
    }
    ...
    public String getSegment(Context context) throws FrameworkException {
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, PreferenceConstants.Preferences.PRODUCT_SEGMENT.get());
    }

    public String getSegmentName(Context context) throws FrameworkException {
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        String segmentID = userPreferenceUtil.getAdminPropertyWithoutCache(context, PreferenceConstants.Preferences.PRODUCT_SEGMENT.get());
    ...
    public String getSegment(Context context, PreferenceManagement preferenceManagement, UserPreferenceUtil userPreferenceUtil) throws FrameworkException {
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, preferenceManagement, PreferenceConstants.Preferences.PRODUCT_SEGMENT.get());
    }
    ...
    public String getProductComplianceRequired(Context context, PreferenceManagement preferenceManagement, UserPreferenceUtil userPreferenceUtil) throws FrameworkException {
        return userPreferenceUtil.getAdminPropertyWithoutCache(context, preferenceManagement, PreferenceConstants.Preferences.PRODUCT_COMPLIANCE_REQUIRED.get());
    }
    ...
    public String getBusinessAreaName(Context context) throws FrameworkException {
        PreferenceManagement preferenceManagement = new PreferenceManagement(context);
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        String businessArea = userPreferenceUtil.getAdminPropertyWithoutCache(context, preferenceManagement, PreferenceConstants.Preferences.PRODUCT_BUSINESS_AREA.get());
    ...
    public String getProductCategoryPlatformName(Context context) throws FrameworkException {
        PreferenceManagement preferenceManagement = new PreferenceManagement(context);
        UserPreferenceUtil userPreferenceUtil = new UserPreferenceUtil();
        String productCategoryPlatform = userPreferenceUtil.getAdminPropertyWithoutCache(context, preferenceManagement, PreferenceConstants.Preferences.PRODUCT_CATEGORY_PLATFORM.get());
    ...
    public Map<String, StringList> getPartTypeRanges(Context context, UserPreferenceUtil userPreferenceUtil) throws FrameworkException {
        ...
        if (preferenceConfigLoader.isLoaded()) {
            productTypes = preferenceConfigLoader.getPreferenceConfig().getProductPreferenceConfig().getTypes();
        }
        return userPreferenceUtil.getPartTypeRanges(context, productTypes);
    }
    ...
    public String getPartTypeJson(Context context, UserPreferenceUtil userPreferenceUtil) throws FrameworkException {
        ...
        if (null != partTypeRanges && !partTypeRanges.isEmpty()) {
            ...
            logger.log(Level.INFO, "Product Part type is not configured in page file pgUserPreferenceConfig");
        }
    ...
    public String getPartTypeJson() throws FrameworkException {
        return getPartTypeJson(UserPreferenceTemplateConstants.Basic.PRODUCT_TYPES_CONFIGURATION.get());
    }
    ...
    public String getPhaseJson(Context context, UserPreferenceUtil userPreferenceUtil, String type) throws Exception {
        ...
        if (UIUtil.isNotNullAndNotEmpty(type)) {
            ...
            if (null != phaseRanges && !phaseRanges.isEmpty()) {
                ...
                logger.log(Level.WARNING, "No Phase found for given type: " + type);
            }
        } else {
    ...
    public String getProductComplianceJson(Context context, UserPreferenceUtil userPreferenceUtil) throws MatrixException {
        JsonObjectBuilder jsonOutput = Json.createObjectBuilder();
        JsonArrayBuilder jsonArr = Json.createArrayBuilder();
        Map<String, StringList> rangeMap = userPreferenceUtil.getProductComplianceRequiredRanges(context);
        if (null != rangeMap && !rangeMap.isEmpty()) {
            StringList choices = rangeMap.get(DataConstants.CONST_FIELD_CHOICES);
            StringList displayChoices = rangeMap.get(DataConstants.CONST_FIELD_DISPLAY_CHOICES);
            JsonObjectBuilder json;
    ...
    public String getProductComplianceJson(Context context) throws MatrixException {
        return getProductComplianceJson(context, new UserPreferenceUtil());
    }

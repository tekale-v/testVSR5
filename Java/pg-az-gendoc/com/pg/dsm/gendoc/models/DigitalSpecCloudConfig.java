...
public class DigitalSpecCloudConfig implements ICloudConfig {
     ...
     * @param context
     */
    public DigitalSpecCloudConfig(Context context) {
        try {
            this.context = context;
            String cloudConfigOid = CloudGenDocUtil.getObjectId(context, CloudConstants.Basic.DIGITAL_SPEC_CLOUD_GEN_DOC_CONFIG_OBJECT.getValue());
            ...
            if (null != objectMap) {
				...
				// Added by DSM (Sogeti) - 2018x.6 Sept-CW for Defect 44025 - Start

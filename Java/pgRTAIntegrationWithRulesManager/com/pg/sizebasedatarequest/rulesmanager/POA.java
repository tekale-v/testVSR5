...
public class POA {
	...
	private String customerConsumerUnit;
    ...
    private List<com.pg.sizebasedatarequest.rulesmanager.RTAOriginlMasterCopy> rtaoriginmastercopy;
	...
	public String getCustomerConsumerUnit() {
		return customerConsumerUnit;
	}

	public void setCustomerConsumerUnit(String customerConsumerUnit) {
		this.customerConsumerUnit = customerConsumerUnit;
	}
	...
	public List<com.pg.sizebasedatarequest.rulesmanager.RTAOriginlMasterCopy> getRtaoriginmastercopy() {
		return rtaoriginmastercopy;
	}

	public void setRtaoriginmastercopy(List<com.pg.sizebasedatarequest.rulesmanager.RTAOriginlMasterCopy> rtaoriginmastercopy) {

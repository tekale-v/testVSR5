package com.pg.gpsdatarequest.rulesmanager;
...
public class RTAOriginLocalCopy {
	...
	private String additionalIfCluster;
	...
	public String getAdditionalIfCluster() {
		return additionalIfCluster;
	}
	public void setAdditionalIfCluster(String additionalIfCluster) {
		this.additionalIfCluster = additionalIfCluster;
	}

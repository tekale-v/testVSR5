...
@Path("/rulesManager")
public class PGRTAClaimService  extends RestService {
	private static final Logger logger = Logger.getLogger("com.pg.claimresponse.ws.rulesmanager.PGRTAClaimService");
	...
	private void createJobObject(Context context,String sJSON,String sOwner) throws FrameworkException{
		...
		job.setAttributeValue(context,DomainConstants.ATTRIBUTE_TITLE,"Claims_RulesManager_ConnectCERequest");
				...
				String sWbServiceUser = EnoviaResourceBundle.getProperty(context, "emxCPN.AAL.applicationUser");
	    	  	...
	    	  	if(BusinessUtil.isNotNullOrEmpty(strPersonId)) {
	    	  		...
	    	  		if(DomainConstants.STATE_PERSON_ACTIVE.equals(domObj.getInfo(context, DomainConstants.SELECT_CURRENT))) {
	    				...
	    				List<com.pg.claimresponse.ws.rulesmanager.POA> poaDataFromRM = reqDataFromRM.getPoa();

...
@ApplicationPath("/pgpicklistapprovertasks")
public class PGPicklistApproverTaskModeler extends ModelerBase
{
  public Class<?>[] getServices()
  {
    return new Class[] {PGPicklistApproverTaskServices.class};
  }
}
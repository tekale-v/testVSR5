...
public class PGSearchAllInfoViewActions extends SearchActionDelegationAdp implements ISearchActionsDelegation {
	private final Logger _logger = Logger.getLogger("com.pg.search.searchactions.PGSearchAllInfoViewActions");
	private final String ID_PG_REFDOC_PGIPMDOC_SEARCH_DOWNOAD = "pgAllInfoView_Download";
	private final String STRING_RESOURCE_KEY_DOWNLOAD = "emxCPN.CommandLabel.AllInfoView";
	private final String STRING_RESOURCE_FRAMEWORK = "emxCPNStringResource";
	private final String SOURCE_JS_PG_REFDOC_PGIPMDOC_SEARCH_ACTIONS = "DS/PGCommonSearchLocalActions/PGSearchLocalActionsForAllInfoView";
	...
	public void computeActions(ActionsHelper helper) {
		...
		try {
			...
			_logger.log(Level.WARNING, "Exception occured in method ComputeActions {0} ", e);
		}
